    ...
    return(
        <div>
            ...
            <div className="question1">
                <h2 className="headddd">Question 2 out of 4</h2>
                <h3>What kind of stocks would you like to invest in?</h3>
                       <button className="buttonashmeet" onClick={()=>nviii('/question3')}>
                        <h4>Growth Stocks</h4>
                        <p>Perks:Growth stocks offer the allure of high returns, with investments in companies on a robust growth trajectory potentially yielding substantial profits over time.</p>
                        ...
                        <button className="buttonashmeet"  onClick={()=>nviii('/question3')}>
                    <h4>Value Stocks</h4>
                        <p>Perks: Value stocks are often priced lower than their intrinsic worth, which can offer investors the opportunity to buy undervalued companies</p>
