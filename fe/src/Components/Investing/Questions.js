        ...
        <NavBlack/>
         <div className="modulesashmeet">
            ...
            <div className="question1">
                <h2 className="headddd">Question 1 out of 4</h2>
                <h3>What kind of stocks would you like to invest in?</h3>
                        <button className="buttonashmeet" onClick={()=>nviii('/question2')}>
                        <h4>Common Stocks</h4>
                        <p>Perks:On buying a Common Stock you get to weigh in on corporate decisions by voting for the board of directors and corporate policies </p>
                    ...
                    <h4>Preferred Stocks</h4>
                        <p>Perks: Preferred stockholders have a higher claim to dividends or asset distribution than common stockholders</p>
